"use strict";
(self["webpackChunkhilltop_backend"] = self["webpackChunkhilltop_backend"] || []).push([[801],{
...
const package_namespaceObject = {"i8":"4.13.4"};
...
const NpsSurvey = () => {
  ...
  const { currentEnvironment, strapiVersion } = (0,helper_plugin_esm/* useAppInfo */.L7)();
  ...
  const handleSubmitResponse = ({ npsSurveyRating: rating, npsSurveyFeedback: comment }) => {
    const { email } = helper_plugin_esm/* auth */.I8.getUserInfo();
    mutate({
      email,
      rating,
      comment,
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(1392), __webpack_require__.e(5317), __webpack_require__.e(8385), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 16593))
);
...
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(57993);
